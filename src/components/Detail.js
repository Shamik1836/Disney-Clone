...
function Detail() {
  return (
    <Container>
      ...
      <SubTitle>7 min 2018 Animation U English</SubTitle>
      <Description>
...
const Background = styled.div`
  // Whenever we give position as fixed or absolute to any child element we must give its pareent position as relative
  position: fixed;
  top: 0;
  left: 0;
  bottom: 0;
